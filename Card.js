class Card {
    constructor(imgn, texto,textoIZ,textoDER, valorOVNI_IZ, valorCREW_IZ,valorSHIPS_IZ,valorMINERALS_IZ,valorOVNI_DER,valorCREW_DER,valorSHIPS_DER,valorMINERALS_DER) {
        this.imgn = imgn;
        this.texto = texto;
